...
function loadBasins(priorityBasinID) {
  ...
  fetch("php/postgresql/loadBasins.php", {
    method: "POST",
    body: formData,
  })
...
function loadRivers(BasinID) {
  ...
  fetch("php/postgresql/loadRivers.php", {
    method: "POST",
    body: formData,
  })
    .then((response) => response.text())
  ...
  // xmlhttp.open("POST", "php/postgresql/loadRivers.php", true);
...
function loadReaches(BasinID, RiverID) {
  ...
  fetch("php/postgresql/loadReaches.php", {
    method: "POST",
    body: formData,
  })
    .then((response) => response.text())
  ...
  // xmlhttp.open("POST", "php/postgresql/loadReaches.php", true);
  // xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
...
function loadDams(BasinID, RiverID) {
  ...
  fetch("php/postgresql/loadDams.php", {
    method: "POST",
    body: formData,
  })
    .then((response) => response.text())
  ...
  // xmlhttp.open("POST", "php/postgresql/loadDams.php", true);
  // xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
  // xmlhttp.send("BasinID=" + BasinID + "&RiverID=" + RiverID);
}
...
function loadBasinGeom(BasinID) {
  ...
  fetch("php/postgresql/loadBasinGeom.php", {
    method: "POST",
    body: formData,
  })
    // .then((response) => response.text())
...
function loadRiversGeom(BasinID) {
  ...
  fetch("php/postgresql/loadRiversGeom.php", {
    method: "POST",
    body: formData,
  })
    // .then((response) => response.text())
  ...
  //   }
  // };
  // xmlhttp.open("POST", "php/postgresql/loadRiversGeom.php", true);
  // xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
  // xmlhttp.send("BasinID=" + BasinID);
}
...
function loadReachesGeom(BasinID) {
  ...
  fetch("php/postgresql/loadReachesGeom.php", {
    method: "POST",
    body: formData,
  })
    // .then((response) => response.text())
  ...
  //   }
  // };
  // xmlhttp.open("POST", "php/postgresql/loadReachesGeom.php", true);
  // xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
  // xmlhttp.send("BasinID=" + BasinID);
}
...
function loadDamsGeom(BasinID) {
  ...
  fetch("php/postgresql/loadDamsGeom.php", {
    method: "POST",
    body: formData,
  })
    // .then((response) => response.text())
  ...
  //   }
  // };
  // xmlhttp.open("POST", "php/postgresql/loadDamsGeom.php", true);
  // xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
  // xmlhttp.send("BasinID=" + BasinID);
}
...
function loadDamsPoints(BasinID) {
  ...
  fetch("php/postgresql/loadDamsPoints.php", {
    method: "POST",
    body: formData,
  })
    // .then((response) => response.text())
...
function zoomToFeatureBounds(type, id, updateTitle = true) {
  ...
  fetch("php/postgresql/getFeatureBounds.php", {
    method: "POST",
    body: formData,
  })
    // .then((response) => response.text())
  ...
  // xmlhttp.open("POST", "php/postgresql/getFeatureBounds.php", true);
  // xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
...
function fetchFeaturePlotData(type, id) {
  if (type == "reach") {
    ...
    fetch("php/postgresql/reachPlotData.php", {
      method: "POST",
      body: formData,
    })
      // .then((response) => response.text())
    ...
    //   }
    // };
    // xmlhttp.open("POST", "php/postgresql/reachPlotData.php", true);
    // // xmlhttp.open("POST", "php/postgresql/reachPlotData_newDB.php", true);
    ...
    fetch("php/postgresql/damPlotData.php", {
      method: "POST",
      body: formData,
    })
      // .then((response) => response.text())
    ...
    //   }
    // };
    // xmlhttp.open("POST", "php/postgresql/damPlotData.php", true);
    // xmlhttp.setRequestHeader(
    //   "Content-type",
    //   "application/x-www-form-urlencoded"
    // );
...
function downloadData() {
  ...
  switch (featureType) {
    case "dam":
      ...
      fetch("php/postgresql/damDataDownload.php", {
        method: "POST",
        body: formData,
        // headers: {
    ...
    case "reach":
      ...
      // Use fetch API to send a POST request to 'download.php'
      fetch("php/postgresql/reachDataDownload.php", {
        method: "POST",
        body: formData,
        // headers: {
        //   "Content-Type": "application/json",
...
function gisDownload() {
  ...
  fetch("php/postgresql/gisDownload.php", {
    method: "POST",
    body: formData,
  })
    .then((response) => response.blob())
...
function getEsriAPIKey() {
  ...
  xmlhttp.open("GET", "php/postgresql/esriAPIkey.php", true);
  xmlhttp.send();
}
