    ...
    def createConnection(self):
        ...
        try:
            ...
            self.connection = connect(
                user=db_config[self.section[0]]["user"],
                database=db_config[self.section[0]]["database"],
                password=db_config[self.section[0]]["password"],
                host=db_config[self.section[0]]["host"],
                port=db_config[self.section[0]]["port"],
            )
